...
class FPNdecoderformer_swin_double(BaseModule):
    def __init__(
        ...
        self.decoder_c5_c4_2 = Fpndecoder(query_pos=pos_c5, kv_pos=pos_c4, mask=None)
        self.decoder_c5_c3_2 = Fpndecoder(query_pos=pos_c5, kv_pos=pos_c3, mask=None)
        self.decoder_c4_c5_2 = Fpndecoder(query_pos=pos_c4, kv_pos=pos_c5, mask=None)
        self.decoder_c3_c5_2 = Fpndecoder(query_pos=pos_c3, kv_pos=pos_c5, mask=None)
